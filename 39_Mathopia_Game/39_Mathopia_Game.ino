...
const unsigned long period = 20000;// time to answer the question

// Array of questions
String problems[15] = {
  "3 X 6 + 116 =","100 / 25 X 25= ","-3 + 2x = 11", "4x + 6 = -10" , "x + 9 = 18 - 2x", "2x + 6 = 4x - 2",
  "-x-1 = 221 + 2x" , "15 + 5x = 0", "2x-10 = 10-3x",  "12x + 60 = 144", "6/2 + 7 X 4 =", 
  "3(125-?) = 3", "x% of 5=6% of 40", "616+ ? +333=255", "[6-{4-(8-6+3)}]"
};
//Array of real solutions
int solutions[15] = {
  134, 100, 7, -4, 3, 4, -74, -3, 4, 7, 31, 124, 48, -694, 7
};
