...
/***********************************************************
Project Title : WheelChair Controlling With Joystick
...
#define yAxis_pin A2 // Joysticks Y-axis
...
if(xAxis > 470 && xAxis <550 && yAxis > 470 && yAxis <550){Stop();Serial.print("x axis : ");Serial.println(xAxis);Serial.print("Y axis : ");Serial.println(yAxis);}
